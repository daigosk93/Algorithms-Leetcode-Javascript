...
const numTrees1 =
  require("../../LeetcodeProblems/Algorithms/Unique_Binary_Search_Trees").numTrees1;
const numTrees2 =
  require("../../LeetcodeProblems/Algorithms/Unique_Binary_Search_Trees").numTrees2;
const numTrees3 =
  require("../../LeetcodeProblems/Algorithms/Unique_Binary_Search_Trees").numTrees3;
